...
For more information, visit our [encyclopedic page about IBO](/nbtc/ibo).
...
However, if you have additional time, consider studying some extra chapters from Matric/F.Sc books as well. These extra chapters are listed in the [table below](#extra-chapters-of-fsc-a-level).
...
Review [sample papers](#sample-paper--worked-solution) to get an idea of the type of questions that may be asked in this section.
...
Review the past descriptive questions from the NBTC Screening Test to get an idea of the type of questions that may be asked. You can find these questions on the [Descriptive Questions page](/nbtc/descriptive-questions).
